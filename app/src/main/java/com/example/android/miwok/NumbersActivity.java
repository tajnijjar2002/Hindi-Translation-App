...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("Six", "Chee", R.drawable.number_six, R.raw.number_six));
        ...
        words.add(new Word("Nine", "Noo'n", R.drawable.number_nine, R.raw.number_nine));
        words.add(new Word("Ten", "Dass", R.drawable.number_ten, R.raw.number_ten));
...
//                    mAudioManager.registerMediaButtonEventReceiver();
                    ...
                    mediaPlayer = MediaPlayer.create(NumbersActivity.this, mediaId);
                    mediaPlayer.start();
